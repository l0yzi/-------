...
init python:
    config.character_id_prefixes.append('barname')
...
style barname is default
style barname_label is say_label
...
style barname:
    ...
    xsize gui.barname_width
    ypos gui.name_ypos
    ysize gui.barname_height

    background Frame("gui/barname.png", gui.barname_borders, tile=gui.barname_tile, xalign=gui.name_xalign)
    padding gui.barname_borders.padding
